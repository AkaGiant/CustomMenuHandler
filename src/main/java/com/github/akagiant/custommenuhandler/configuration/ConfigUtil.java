...
import com.github.akagiant.custommenuhandler.configuration.paths.error.ConfigErrorPaths;
import com.github.akagiant.custommenuhandler.utility.ColorManager;
...
public class ConfigUtil {
	...
	public static Optional<String> getStringSilent(Config config, String path) {
		if (isSetAndStringIsValid(config, path)) {
			return Optional.empty();
		}
		return Optional.of(ColorManager.formatColours(config.getConfig().getString(path)));
